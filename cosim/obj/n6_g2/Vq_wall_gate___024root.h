...
class alignas(VL_CACHE_LINE_BYTES) Vq_wall_gate___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        VL_OUT8(o_nf,3,0);
        VL_OUT8(o_gopen,0,0);
        VL_OUT8(o_em_mask,5,0);
        CData/*1:0*/ q_wall_gate__DOT__st;
        CData/*5:0*/ q_wall_gate__DOT__trig;
        ...
        CData/*0:0*/ q_wall_gate__DOT__guard_hit;
        CData/*0:0*/ q_wall_gate__DOT__sall;
        CData/*5:0*/ q_wall_gate__DOT____Vlvbound_h527fd750__0;
        ...
        VL_IN(i_seed,31,0);
        VL_OUTW(o_em_pm,287,0,9);
        VL_OUTW(o_em_e,287,0,9);
        ...
        QData/*47:0*/ q_wall_gate__DOT____Vlvbound_hc3744b18__1;
        QData/*47:0*/ q_wall_gate__DOT____Vlvbound_hb3a0a8ac__0;
        QData/*47:0*/ q_wall_gate__DOT____Vlvbound_h546c86fe__0;
        QData/*47:0*/ q_wall_gate__DOT____Vlvbound_he80f3aea__0;
        QData/*47:0*/ q_wall_gate__DOT____Vlvbound_h686cd9a7__1;
        ...
        VlUnpacked<VlUnpacked<QData/*47:0*/, 6>, 1> q_wall_gate__DOT__mags;
        VlUnpacked<CData/*3:0*/, 1> q_wall_gate__DOT__cnt;
        VlUnpacked<CData/*5:0*/, 6> q_wall_gate__DOT__i_lats_reg;
        VlUnpacked<QData/*47:0*/, 6> q_wall_gate__DOT__reads;
        VlUnpacked<QData/*47:0*/, 6> q_wall_gate__DOT__errs;
    };
    struct {
        VlUnpacked<QData/*47:0*/, 6> q_wall_gate__DOT__pm_new;
    };
