...
- **Open gaps: 7 + residues** (B1, B2, B6, B8, B9, B10 open; B7 half-closed; B3/B4/B5 closed-bounded with residues; B11, B12 closed via `7375afb` + the PIPE_EFF=1 re-proof), each with its exact closing artifact and a size estimate.
