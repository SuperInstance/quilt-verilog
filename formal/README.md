...
| `cell_core.fair.sby` | I1a op bound (gap ≤ 64, tick-free), I1b composite (gap ≤ 128, spaced ticks), I2 response ≤ 66 | BMC 130 in tree since 2026-08-30 (Finding 3 re-run depth; at 80, I1b's gap≤128 cannot be expressed). Last complete PASS: BMC 80, 2026-08-29; depth-130 completion pending — see VERIFICATION.md Lane 3 serialize rule | **PASS** (80) | 15 m 19 s |
