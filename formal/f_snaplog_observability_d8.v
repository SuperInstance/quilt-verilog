...
module f_snaplog_observability_d8(input clk, input rst_n);
    localparam PW = 16, AIDW = 4, TICKW = 24, DEPTH = 8, MAG = 1;   // d8 variant
    localparam EW = TICKW + 1 + AIDW + PW;   // 45
    localparam IDXW = 3;                     // clog2(DEPTH)
    localparam JOURNAL = 12, JW = 4;         // full-wave shadow depth (window variant)
