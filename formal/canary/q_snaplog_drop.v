...
module q_snaplog_drop #(
    ...
    always @(posedge clk) begin
        if (!rst_n) begin
            ...
            // CANARY MUTATION: the first fire at count==5 is silently
            // swallowed (no shift, no count, no drop) -- a lost observation.
            if (fire_now && !(count == 5'd5 && drops == {TICKW{1'b0}})) begin
